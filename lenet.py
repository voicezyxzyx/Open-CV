...
def load_data():
    ...
    imgs = os.listdir("C:/Users/Administrator/Pictures/cp.jpg")
    num = len(imgs)
    for i in range(num):
        img = Image.open("C:/Users/Administrator/Pictures/cp.jpg"+imgs[i])
...
#具体看这里说明：http://deeplearning.net/software/theano/library/tensor/nnet/conv.html
...
#第二个卷积层，8个卷积核，每个卷积核大小3*3。4表示输入的特征图个数，等于上一层的卷积核个数#激活函数用tanh
...
#4是根据每个卷积层计算出来的：(28-5+1)得到24,(24-3+1)/2得到11，(11-3+1)/2得到4
